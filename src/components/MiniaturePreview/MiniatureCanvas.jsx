  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 mb-6 shadow-lg">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-100">Primaris Marine Color Preview</h1>
        ...
        {/* Instructions */}
        <div className="mt-6 bg-slate-800 rounded-xl border border-slate-700 p-6 shadow-lg">
